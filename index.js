...
class Action {
    constructor() {
        ...
        this.buildNumber = process.env.INPUT_BUILD_NUMBER
    ...
    _pushPackage(version, name) {
        ...
        this._executeInProcess(`dotnet pack -p:PackageVersion=${this.version} -p:PackageName=${this.packageName} ${this.includeSymbols ? "--include-symbols -p:SymbolPackageFormat=snupkg" : ""} --no-build -c Release ${this.projectFile} -o .`)
